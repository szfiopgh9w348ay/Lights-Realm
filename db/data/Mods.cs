...
namespace db.data
{
    internal class Mods
    {
        private static string ServerName = "ROTMGServer";
        private static string ds = Path.DirectorySeparatorChar.ToString();
        private static string BaseModDir = Environment.ExpandEnvironmentVariables("%USERPROFILE%" + ds + "RotMG Server Mods"); //Located in your user folder
