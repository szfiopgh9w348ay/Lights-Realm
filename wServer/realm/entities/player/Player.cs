...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        public Player(Client client) : base((short)client.Character.ObjectType, client.Random)
        {
            this.client = client;
        ...
        public override void Init(World owner)
        {
            ...
            SetNewbiePeriod();
            if (!client.CheckAccountInUse(AccountId))
                base.Init(owner);
            else
                client.Disconnect();
            if (client.Character.Pet >= 0)
                GivePet((short)client.Character.Pet);
                ...
                if (p != null)
                {
                    ...
                    else
                    {
                        switch (entity.ObjectType) //handling default case for not found. Add more as implemented
                        {
                            ...
                            case 0x0720:
                                world = RealmManager.PlayerVault(client);
