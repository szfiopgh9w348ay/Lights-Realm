        ...
        public void Execute(Player player, string[] args)
        {
            ...
            else
            {
                foreach (var i in player.Owner.Players)
                {
                    if (i.Value.nName.ToLower() == args[0].ToLower().Trim())
                    {
                        i.Value.Teleport(new RealmTime(), new TeleportPacket()
                        {
                            ObjectId = player.Id
                        });
                        return;
            ...
            try
            {
                using (var db = new Database())
                {
                    ...
                    else
                    {
                        ...
                        Program.logger.Info($"{player.nName} has whitelisted {args[0]}");
                        var dir = @"logs";
                    ...
                    else
                    {
                        foreach (var i in player.Owner.Players)
                        {
                            if (i.Value.nName.ToLower() == args[0].ToLower().Trim())
                            {
                                ...
                                Program.logger.Info($"{args[0]} was Banned.");
                            }
                        }
                    }
                }
            ...
            try
            {
                using (var db = new Database())
                {
                    ...
                    else
                    {
                        ...
                        Program.logger.Info($"{args[1]} was Unbanned.");                        
                    }
                }
            }
            catch
            ...
            else
            {
                try
                {
                    using (var db = new Database())
                    {
                        ...
                        Program.logger.Info($"{args[1]}'s guild rank has been changed");
                    }
                }
                catch
                {
            ...
            else
            {
                try
                {
                    using (var db = new Database())
                    {
                        ...
                        Program.logger.Info($"{args[1]}'s guild has been changed");
                    }
                }
                catch
                {
