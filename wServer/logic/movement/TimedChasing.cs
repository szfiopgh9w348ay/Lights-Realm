...
namespace wServer.logic.movement
{
    internal class TimedChasing : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, float, float, int, short?>, TimedChasing> instances = new Dictionary<Tuple<float, float, float, int, short?>, TimedChasing>();
