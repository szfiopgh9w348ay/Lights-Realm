...
namespace wServer.logic.movement
{
    internal class Chasing : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, float, float, short?>, Chasing> instances = new Dictionary<Tuple<float, float, float, short?>, Chasing>();
    ...
    internal class PetChasing : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, float, float>, PetChasing> instances = new Dictionary<Tuple<float, float, float>, PetChasing>();
