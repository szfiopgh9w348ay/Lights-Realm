...
namespace wServer.logic.attack
{
    internal class PredictiveMultiAttack : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, float, int, float, int>, PredictiveMultiAttack> instances = new Dictionary<Tuple<float, float, int, float, int>, PredictiveMultiAttack>();
