...
namespace wServer.logic.attack
{
    internal class PredictiveRingAttack : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, float, float, int>, PredictiveRingAttack> instances = new Dictionary<Tuple<int, float, float, int>, PredictiveRingAttack>();
