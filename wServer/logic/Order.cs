...
namespace wServer.logic
{
    internal class OrderGroup : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, string, Behavior>, OrderGroup> instances = new Dictionary<Tuple<float, string, Behavior>, OrderGroup>();
    ...
    internal class OrderEntity : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, short, Behavior>, OrderEntity> instances = new Dictionary<Tuple<float, short, Behavior>, OrderEntity>();
    ...
    internal class OrderAllEntity : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, short, Behavior>, OrderAllEntity> instances = new Dictionary<Tuple<float, short, Behavior>, OrderAllEntity>();
