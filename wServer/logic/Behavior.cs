...
namespace wServer.logic
{
    ...
    public abstract class BehaviorBase
    {
            ...
            if (objType == null)
                foreach (var i in Host.Self.Owner.PlayersCollision.HitTest(Host.Self.X, Host.Self.Y, dist))
                {
                    if (!(i as IPlayer).IsVisibleToEnemy() &&
                        !Host.StateStorage.ContainsKey(MAGIC_EYE_KEY))
                        continue;
        ...
        public static bool Validate(Entity entity, float x, float y)
        {
            ...
            if (entity.ObjectDesc.Flying &&
                entity.Owner.Obstacles[(int)x, (int)y] != 2)
                return true;
    ...
    internal class Cooldown : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior>, Cooldown> instances = new Dictionary<Tuple<int, Behavior>, Cooldown>();
    ...
    internal class RandomDelay : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, int>, RandomDelay> instances = new Dictionary<Tuple<int, int>, RandomDelay>();
    ...
    internal class CooldownExact : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior>, CooldownExact> instances = new Dictionary<Tuple<int, Behavior>, CooldownExact>();
    ...
    internal class If : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<Behavior, Behavior, Behavior>, If> instances = new Dictionary<Tuple<Behavior, Behavior, Behavior>, If>();
    ...
    internal class IfNot : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<Behavior, Behavior>, IfNot> instances = new Dictionary<Tuple<Behavior, Behavior>, IfNot>();
    ...
    internal class IfExist : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior, Behavior>, IfExist> instances = new Dictionary<Tuple<int, Behavior, Behavior>, IfExist>();
    ...
    internal class IfEqual : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, int, Behavior, Behavior>, IfEqual> instances = new Dictionary<Tuple<int, int, Behavior, Behavior>, IfEqual>();
    ...
    internal class IfGreater : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, int, Behavior, Behavior>, IfGreater> instances = new Dictionary<Tuple<int, int, Behavior, Behavior>, IfGreater>();
    ...
    internal class HpLesser : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior, Behavior>, HpLesser> instances = new Dictionary<Tuple<int, Behavior, Behavior>, HpLesser>();
    ...
    internal class DamageLesserEqual : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior, Behavior>, DamageLesserEqual> instances = new Dictionary<Tuple<int, Behavior, Behavior>, DamageLesserEqual>();
    ...
    internal class HpGreaterEqual : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior, Behavior>, HpGreaterEqual> instances = new Dictionary<Tuple<int, Behavior, Behavior>, HpGreaterEqual>();
    ...
    internal class HpLesserCond : ConditionalBehavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior, Behavior>, HpLesserCond> instances = new Dictionary<Tuple<int, Behavior, Behavior>, HpLesserCond>();
    ...
    internal class HpLesserPercent : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, Behavior, Behavior>, HpLesserPercent> instances = new Dictionary<Tuple<float, Behavior, Behavior>, HpLesserPercent>();
    ...
    internal class And : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<Behavior, Behavior>, And> instances = new Dictionary<Tuple<Behavior, Behavior>, And>();
    ...
    internal class Or : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<Behavior, Behavior>, Or> instances = new Dictionary<Tuple<Behavior, Behavior>, Or>();
    ...
    internal class Timed : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<int, Behavior>, Timed> instances = new Dictionary<Tuple<int, Behavior>, Timed>();
    ...
    internal class Die : Behavior
    {
        ...
        protected override bool TickCore(RealmTime time)
        {
            ...
            {
                Program.logger.Error("Crash halted! - Nonexistent entity tried to die!");
            }
            return true;
        }
    }
    ...
    internal class IsEntityPresent : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, short?>, IsEntityPresent> instances = new Dictionary<Tuple<float, short?>, IsEntityPresent>();
    ...
    internal class IsEntityNotPresent : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, short?>, IsEntityNotPresent> instances = new Dictionary<Tuple<float, short?>, IsEntityNotPresent>();
    ...
    internal class EntityLesserThan : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, int, short?>, EntityLesserThan> instances = new Dictionary<Tuple<float, int, short?>, EntityLesserThan>();
    ...
    internal class EntityGroupLesserThan : Behavior
    {
        ...
        private static readonly Dictionary<Tuple<float, int, string>, EntityGroupLesserThan> instances = new Dictionary<Tuple<float, int, string>, EntityGroupLesserThan>();
    ...
    {
        private ConditionEffects[] effects;
        ...
        private static readonly Dictionary<ConditionEffects[], CheckConditionEffects> instances = new Dictionary<ConditionEffects[], CheckConditionEffects>();
