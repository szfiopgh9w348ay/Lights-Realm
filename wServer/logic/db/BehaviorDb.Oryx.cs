                    ...
                    new RunBehaviors(
                        ...
                        IfEqual.Instance(-1, 3,
                            ...
                            new RunBehaviors(
                                ...
                                Once.Instance(TossEnemy.Instance(360 * (float)Math.PI / 180, 8, 0x1742))
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 0 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 18 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 36 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 54 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 72 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 90 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 108 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 126 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 144 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 162 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 180 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 198 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 216 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 234 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 252 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 270 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 288 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 306 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 324 * (float)Math.PI / 180, projectileIndex: 0))),
                            // Cooldown.Instance(250, new RunBehaviors(RingAttack.Instance(3,
                            // offset: 342 * (float)Math.PI / 180, projectileIndex: 0)))
                            )),
