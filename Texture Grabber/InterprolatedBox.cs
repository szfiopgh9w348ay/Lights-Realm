...
namespace Texture_Grabber
{
    ...
    internal class InterpolatedBox : PictureBox
    {
        ...
        /// <summary>The interpolation used to render the image.</summary>
        ...
        /// <summary>Overridden to modify rendering behavior.</summary>
        /// <param name="pe">Painting event args.</param>
        protected override void OnPaint(PaintEventArgs pe)
        {
            // Before the PictureBox renders the image, we modify the graphics object to change the interpolation.

            // Set the selected interpolation.
            pe.Graphics.InterpolationMode = interpolation;
            // Certain interpolation modes (such as nearest neighbor) need to be offset by half a
            // pixel to render correctly.
